...
geojson = (function(_this) {
  return function(geo, opts, callback) {
    if (opts == null) {
      opts = {};
    }
...
_search = (function(_this) {
  return function(geo, opts, callback, results, queryContinue) {
...
_convert = function(results, opts, callback) {
  var article, articleId, feature, geo, image, imageUrl, md5sum, titleEscaped, url, _ref;
  geo = {
